...
urlpatterns = [
    ...
    path('single/index.html/', Home_view, name='index_single_blog'),
    path('single/about.html/', About_view, name='about_single_blog'),
    path('/single/contact.html/', Contact_view, name='contact_single_blog'),
]